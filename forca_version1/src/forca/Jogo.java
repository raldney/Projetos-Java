...
public class Jogo {
    ...
    char palavraSecreta[] = {'B', 'A', 'N', 'A', 'N', 'A'};
    char palavraErrada[] = {' ', ' ', ' ', ' ', ' ', ' '};
    char palavraUsada[] = new char[palavraSecreta.length + palavraErrada.length + 1];
    ...
    int letrasCertas() {
        int countAux = 0;
        while (palavraUsada[countAux] != '|' && palavraUsada[countAux] == palavraSecreta[countAux]) {
            countAux++;
        }
        return countAux;
    }
